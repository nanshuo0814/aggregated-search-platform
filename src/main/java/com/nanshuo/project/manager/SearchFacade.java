...
import com.nanshuo.project.datasource.*;
...
public class SearchFacade {
    ...
    public SearchVO searchAll(@RequestBody SearchRequest searchRequest, HttpServletRequest request) {
        ...
        if (searchTypeEnum == null) {
            CompletableFuture<Page<UserSafetyVO>> userTask = CompletableFuture.supplyAsync(() -> {
                UserQueryRequest userQueryRequest = new UserQueryRequest();
                userQueryRequest.setUserName(searchText);
                Page<UserSafetyVO> userVOPage = userDataSource.doSearch(searchText, current, pageSize);
                return userVOPage;
            });
            ...
            try {
                Page<UserSafetyVO> userVOPage = userTask.get();
